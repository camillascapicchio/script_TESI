...
filepath="/home/users/camilla/BIRADS_crop/Senograph53/23SETTEMBRE2019/1/weights-improvement-{epoch:02d}-{val_acc:.2f}.h5"
...
tensorboard = TensorBoard(log_dir="/home/users/camilla/BIRADS_crop/Senograph53/23SETTEMBRE2019/1/logs/{}".format(time()), histogram_freq=0, batch_size=4, write_grads=True, write_images=True)
...
np.savetxt('/home/users/camilla/BIRADS_crop/Senograph53/23SETTEMBRE2019/1/loss_train.txt', history.history['loss'], delimiter=",")
np.savetxt('/home/users/camilla/BIRADS_crop/Senograph53/23SETTEMBRE2019/1/acc_train.txt', history.history['acc'], delimiter=",")
np.savetxt('/home/users/camilla/BIRADS_crop/Senograph53/23SETTEMBRE2019/1/loss_val.txt', history.history['val_loss'], delimiter=",")
np.savetxt('/home/users/camilla/BIRADS_crop/Senograph53/23SETTEMBRE2019/1/acc_val.txt', history.history['val_acc'], delimiter=",")


model.save('/home/users/camilla/BIRADS_crop/Senograph53/23SETTEMBRE2019/1/final_weights.h5')
